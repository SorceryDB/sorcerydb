...
class IndexController extends Controller
{
    ...
    public function indexAction(Request $request, EntityManagerInterface $entityManager, DecklistManager $decklistManager)
    {
        ...
        return $this->render(
            ...
            [
                'pagetitle'       => "Sorcery: Contested Realm Cards and Deckbuilder",
                'pagedescription' => "Build your deck for Sorcery: Contested Realm, the TCG by Erik's Curiosa Limited. Browse the cards and the thousand of decklists submitted by the community. Publish your own decks and get feedback.",
